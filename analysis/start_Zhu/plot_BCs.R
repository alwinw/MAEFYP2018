...
source("../../R/src_library-manager.R")                         # Call libraries and install missing ones
source("../../R/src_helper-functions.R")                        # Smaller functions used
...
# Zhu condition
MOD_ALPHA_X = "-(PI/2*cos(PI*t/2) - PI/2*cos(PI*t/2)*heav(t-1))"

u = "sin(PI*t/2) - (sin(PI*t/2)-1)*heav(t-1)"
