...
#--- * Required Paths                                             ----
saveplot   = "../src-example/NACA0012_remesh_example/"                          # Pass in later to plot_data
airfoil    = "NACA0012-Remesh"
folderpath = "../src-example/NACA0012_remesh_example/results/"
seshpath   = "NACA0012_remesh"
dumppath   = "NACA0012_remesh-10.dump"
...
ggsave("NS_Remesh_NP8.png", plot = plot_nsG, scale = 1.5,
